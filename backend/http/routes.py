...
def setup_api_routes(app: web.Application) -> None:
    ...
    app.router.add_post("/api/scheme-files/list", scheme_files_list)
    app.router.add_post("/api/scheme-files/create", scheme_files_create)
    app.router.add_post("/api/scheme-files/save", scheme_files_save)
    app.router.add_post("/api/scheme-files/delete", scheme_files_delete)
    app.router.add_post("/api/tasks/list", tasks_list)
    app.router.add_post("/api/tasks/get", tasks_get)
    app.router.add_post("/api/tasks/save-draft", tasks_save_draft)
    app.router.add_post("/api/tasks/submit", tasks_submit)
    app.router.add_post("/api/admin/tasks/list", admin_tasks_list)
    app.router.add_post("/api/admin/tasks/create", admin_tasks_create)
    app.router.add_post("/api/admin/tasks/save", admin_tasks_save)
    app.router.add_post("/api/admin/tasks/delete", admin_tasks_delete)
