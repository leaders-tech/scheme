...
.PHONY: help setup back back-once front open back-lan front-lan open-lan back-docker front-docker open-docker stop-docker clean-docker schemio-build schemio-test schemio-playground-build schemio-playground-pack format test test-e2e-docker deps-update-safe deps-update-latest
...
help:
	...
	@printf "  make schemio-playground-pack Check the npm package for the Schemio web component\n"
...
schemio-playground-pack:
	cd frontend && npm run pack:check
